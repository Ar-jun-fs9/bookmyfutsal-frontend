        ...
        <div className="flex flex-col items-center space-y-4 w-full max-w-md">
          ...
          <div className="flex w-full space-x-3">
            ...
            <button
              ...
              className="bg-linear-to-r from-green-400 to-blue-500 text-neutral-900 font-semibold py-3 px-6 rounded-lg shadow-lg hover:scale-[1.02] hover:shadow-xl transition-all duration-300"
            >
              Track Booking
            </button>
          </div>
