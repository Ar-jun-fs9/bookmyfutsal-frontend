        ...
        <div className="relative">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {visibleTestimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`rounded-2xl p-3 hover:shadow-2xl transform hover:scale-102 transition-all duration-500 border ${
                  index === subIndex && testimonialsPerPage > 1 ? 'border-green-500 ring-1 ring-green-200' : 'border-gray-300'
                }`}
