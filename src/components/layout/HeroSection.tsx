  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://res.cloudinary.com/dftpt1jaz/image/upload/v1773333569/hero_section_zvl6h2.jpg"
          alt="Futsal Court"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="flex justify-center lg:justify-end  delay-300 relative">
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 flex items-center justify-center">
            ...
            <img
              src="https://res.cloudinary.com/dftpt1jaz/image/upload/v1773643699/logo1_y6k4qr.png"
