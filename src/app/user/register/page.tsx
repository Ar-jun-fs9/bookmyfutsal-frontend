...
export default function UserRegister() {
  ...
  useEffect(() => {
    ...
    if (state.emailCountdown > 0 || state.phoneCountdown > 0) {
      interval = setInterval(() => {
        dispatch({ type: "DECREMENT_COUNTDOWNS" });
      }, 1000);
    }
  ...
  }, [state.emailCountdown, state.phoneCountdown]);
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStep(2);
        setEmailCountdown(60); // Start 1-minute countdown for email
        setPhoneCountdown(60); // Start 1-minute countdown for phone
        showNotification({
          message: `Registration initiated! OTPs sent to ${formData.email} and ${formData.phone}. Email OTP: ${data.otps.email}, Phone OTP: ${data.otps.phone}`,
          type: "info",
        });
      } else {
  ...
  const handleResendOTP = async () => {
    ...
    try {
      ...
      if (emailResponse.ok && phoneResponse.ok) {
        ...
        showNotification({
          message: `OTPs resent! Email OTP: ${emailData.otp_code}, Phone OTP: ${phoneData.otp_code}`,
          type: "info",
        });
      } else {
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <h1
                ...
                className="text-2xl md:text-3xl font-bold text-white drop-shadow-lg cursor-pointer"
              >
            ...
            <div className="relative p-6 sm:p-8">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">
                  {step === 1
                    ? "Join BookMyFutsal and start booking your favorite venues"
                    : "Enter the OTPs sent to your email and phone to complete registration"}
                </p>
              </div>
                        ...
                        <div className="relative">
                          ...
                          <div className="relative">
                            <input
                              ...
                              type="text"
                              required
                              className="w-full px-4 py-2.5 pl-10 border-2 border-gray-200 rounded-lg focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all duration-300 text-gray-700 font-medium text-sm"
                        ...
                        <div className="relative">
                          ...
                          <div className="relative">
                            <input
                              ...
                              required
                              className="w-full px-4 py-2.5 pl-10 pr-10 border-2 border-gray-200 rounded-lg focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all duration-300 text-gray-700 font-medium text-sm"
                    ...
                    {error && (
                      <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                        <div className="flex items-center">
                          <svg
                            className="w-4 h-4 text-red-600 mr-2 shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                    ...
                    <div className="space-y-3">
                      {emailCountdown > 0 || phoneCountdown > 0 ? (
                        <button
                          type="submit"
                          disabled={
                            loading || !otpData.email_otp || !otpData.phone_otp
                          }
                          className="w-full bg-linear-to-r from-green-500 to-green-600 text-white font-semibold py-2.5 px-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-green-400/30 text-sm"
                        >
                          <span className="flex items-center justify-center">
                        ...
                        <button
                          ...
                          disabled={loading}
                          className="w-full bg-linear-to-r from-blue-500 to-blue-600 text-white font-semibold py-2.5 px-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-blue-400/30 text-sm"
                        >
                          <span className="flex items-center justify-center">
                            {loading ? (
                              <>
