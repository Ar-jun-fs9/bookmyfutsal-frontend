...
export default function BookFutsal() {
  ...
  const futsalId = params?.futsalId
    ? parseInt(params.futsalId as string, 10)
    : undefined;
  const router = useRouter();

  // Server state with React Query
  const { data: futsal, isLoading: futsalLoading } = useFutsal(
    Number(params.futsalId)
  );
    ...
    if (summaryRef.current) {
      ...
      try {
        ...
        try {
          ...
          console.error(
            `Fallback ${format.toUpperCase()} generation failed:`,
            fallbackError
          );
          showNotification({
            message: `Unable to download ${format.toUpperCase()}. Please try again or contact support.`,
            type: "info",
          });
        }
      } finally {
  ...
  const handleSlotSubmit = async (e: React.FormEvent) => {
    ...
    const currentStatus = await checkSlotStatus(
      bookingState.selectedSlotIds[0]
    );

    if (currentStatus !== "available" && currentStatus !== "pending") {
      if (currentStatus === "booked") {
        showNotification({
          message: "Slot is already booked. Please choose another slot.",
          type: "info",
        });
    ...
    try {
      ...
      if (registeredData.isRegistered) {
        showNotification({
          message:
            "A user with this phone number already exists. Please log in to make a booking or use a different number.",
          type: "info",
        });
        return;
      }
      ...
      if (checkData.verified) {
        ...
        if (otpResponse.ok) {
          ...
          showNotification({
            message: `OTP sent to ${bookingState.phone}. OTP: ${otpData.otp_code}`,
            type: "info",
          });
  ...
  const handleResendOTP = async () => {
    try {
      ...
      if (otpResponse.ok) {
        ...
        setOtpCountdown(60);
        showNotification({
          message: `OTP resent to ${bookingState.phone}. OTP: ${otpData.otp_code}`,
          type: "info",
        });
      } else {
    ...
    <div className="min-h-screen bg-linear-to-br from-green-50 via-white to-blue-50">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <img
                  src="/logo/logo.png"
                  alt="BookMyFutsal"
                  className="h-12 w-12 rounded-lg shadow-lg ring-2 ring-green-400/50"
                />
        ...
        <div className="max-w-4xl px-4">
          ...
          <div className="hidden sm:flex sm:flex-row items-center space-x-4">
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 1 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Date
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 2 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Shift
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 3 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Slot
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 4 ? "text-green-600" : "text-gray-500"
                }`}
              >
                OTP
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 5 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Payment
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 6 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Tracking
              </span>
            ...
            <div className="flex items-center">
              ...
              <span
                className={`ml-2 text-sm font-medium ${
                  bookingState.step >= 7 ? "text-green-600" : "text-gray-500"
                }`}
              >
                Summary
              </span>
                ...
                <div className="relative p-5">
                  ...
                  <div className="text-center mb-5">
                    ...
                    <p className="text-gray-600 text-sm">
                      Choose the perfect day for your futsal adventure
                    </p>
                  </div>
                  ...
                  <div className="space-y-7">
                    <div className="relative">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 pl-12 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all duration-300 text-gray-700 font-medium bg-white shadow-sm"
                        />
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                      <button
                        onClick={() => {
                          if (bookingState.selectedSlotIds.length > 0) {
                            bookingState.selectedSlotIds.forEach((id) =>
                              releaseSlotReservation(id)
                            );
                            dispatch({ type: "CLEAR_SELECTED_SLOTS" });
                          }
                          router.push("/");
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
                ...
                <div className="relative p-8">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-sm">
                      Pick the time period that works best for you
                    </p>
                  </div>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
                ...
                <div className="relative p-8">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-sm">
                      Choose the perfect time for your game
                    </p>
                    {showOtpNote && !loggedInUser && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                        <p className="text-sm text-blue-800">
                          📱 <strong>OTP Verification:</strong> One-time
                          verification required for new numbers. If you've
                          booked before with this number, no OTP needed.
                        </p>
                      </div>
                    )}
                  </div>
                        ...
                        {availableSlots.map((slot: any) => (
                          <button
                            ...
                            disabled={
                              ...
                              !bookingState.selectedSlotIds.includes(
                                slot.slot_id
                              )
                            }
                                    ...
                                    if (value.length === 10) {
                                      ...
                                      try {
                                        ...
                                        if (data.verified && data.guest_name) {
                                          dispatch({
                                            type: "SET_NAME",
                                            payload: data.guest_name,
                                          });
                                          dispatch({
                                            type: "SET_NUMBER_OF_PLAYERS",
                                            payload:
                                              data.number_of_players?.toString() ||
                                              "5",
                                          });
                                          dispatch({
                                            type: "SET_TEAM_NAME",
                                        ...
                                        console.error(
                                          "Error fetching last booking details:",
                                          error
                                        );
                ...
                <div className="relative p-8">
                  ...
                  <div className="bg-linear-to-r from-green-100 to-blue-100 rounded-xl p-4 mb-6 border border-green-200">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-sm font-medium text-green-800">
                        OTP sent to:{" "}
                        <span className="font-bold">{bookingState.phone}</span>
                      </span>
                    </div>
                  </div>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
                ...
                <div className="relative p-8">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-sm">
                      Pay Rs. 100 advance to confirm your booking
                    </p>
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      This should be the phone number registered with your eSewa
                      account
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button
                      onClick={async () => {
                        if (!esewaPhone.trim()) {
                          showNotification({
                            message: "Please enter your eSewa phone number",
                            type: "info",
                          });
                          return;
                        }
                        ...
                        try {
                          const bookingResponse =
                            await createBookingMutation.mutateAsync({
                              ...
                              number_of_players:
                                Number(bookingState.numberOfPlayers) || 5,
                          ...
                          if (bookingResponse) {
                            ...
                            dispatch({
                              type: "SET_GENERATED_TRACKING_CODE",
                              payload: bookingResponse.booking.tracking_code,
                            });
              ...
              >
                ...
                <div className="relative p-2 md:p-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {bookingState.booking.futsal_name}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          <span className="text-gray-600 font-medium">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {bookingState.booking.location},{" "}
                            {bookingState.booking.city}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          <span className="text-gray-600 font-medium">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-green-100">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {formatDate(bookingState.booking.booking_date)}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          <span className="text-gray-600 font-medium">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {formatDate(
                              bookingState.booking.created_at.split("T")[0]
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {formatBookingTimeRange(
                              bookingState.booking.time_slot
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {bookingState.booking.number_of_players}
                          </span>
                        </div>
                        {booking.team_name && (
                          <div className="flex justify-between items-start">
                            ...
                            <span className="text-gray-800 font-semibold text-right ml-2">
                              {bookingState.booking.team_name}
                            </span>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-green-100 md:col-span-1 lg:col-span-1">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-green-600 font-bold text-lg text-right ml-2">
                            Rs. {bookingState.booking.amount_paid}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          <span className="text-gray-600 font-medium">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            Rs. {bookingState.booking.price_per_hour}
                          </span>
                        </div>
                        <div className="flex justify-between items-start">
                          <span className="text-gray-600 font-medium">
                          ...
                          <span className="text-gray-800 font-semibold text-right ml-2">
                            {bookingState.booking.tracking_code}
                          </span>
                        </div>
                        {!loggedInUser && (
                          <>
                            <div className="flex justify-between items-start">
                              ...
                              <span className="text-gray-800 font-semibold text-right ml-2">
                                {bookingState.booking.guest_name}
                              </span>
                            </div>
                            <div className="flex justify-between items-start">
                              <span className="text-gray-600 font-medium">
                              ...
                              <span className="text-gray-800 font-semibold text-right ml-2">
                                {bookingState.booking.guest_phone}
                              </span>
                            </div>
                          </>
                        )}
                  ...
                  {!loggedInUser && booking.tracking_code && (
                    <div className="bg-linear-to-r from-gray-50 to-gray-100 rounded-2xl p-6 mb-8 border border-gray-200">
                      <div className="text-center">
                        ...
                        <div className="bg-white border-2 border-blue-200 rounded-xl p-4 mb-2 shadow-inner">
                          <div className="text-3xl md:text-4xl font-mono font-bold text-blue-600 tracking-wider">
                            {bookingState.booking.tracking_code}
                          </div>
                        </div>
                  ...
                  <div className="bg-linear-to-r from-yellow-50 to-orange-50 rounded-2xl p-6 mb-8 border border-yellow-200">
                    ...
                    <div className="space-y-3 text-sm text-yellow-800">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          {!loggedInUser && booking.tracking_code && (
                            <span>
                              {" "}
                              Use your tracking code to manage your booking.
                            </span>
                          )}
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          <strong>Cancellation Policy:</strong> Non-refundable.
                          Free cancellation allowed up to 2 hours before play.
                        </div>
                      </div>
                      <div className="flex items-start">
                        <span className="text-lg mr-3 mt-0.5">👤🔄</span>
                        <div>
                          <strong>Account Benefit:</strong> Create an account to
                          reschedule bookings and make multiple bookings easily.
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 px-6 md:px-8 py-4 border-t border-gray-200">
                  <div className="text-center text-sm text-gray-600">
                    <p>
                      Experience the future of sports booking • BookMyFutsal ©
                      2026
                    </p>
                  </div>
                </div>
      ...
      {notification && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 ">
          <div
            className={`max-w-sm w-full bg-white rounded-2xl shadow-2xl border p-6 transform transition-all duration-300 ${
          ...
          <div className="grid grid-cols-1 gap-8 mb-8 md:hidden">
            ...
            <div className="-up">
              ...
              <p className="text-gray-300 mb-4">
                Your ultimate destination for booking premium futsal venues.
                Experience the thrill of the game with top-quality facilities.
              </p>
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-300 text-sm">
                  📧 bookmyfutsal@gmail.com
                </p>
                <p className="text-gray-300 text-sm">📞 +977- 980000009</p>
              </div>
              <div className="text-center">
            ...
            <div className="text-center border-t border-gray-700 pt-6">
              <p className="text-gray-400">
                &copy; 2026 BookMyFutsal. All rights reserved. Experience the
                future of sports booking.
              </p>
            </div>
          </div>
        </div>
