...
export default function RootPage() {
   ...
   useEffect(() => {
     const hasModalOpen = videoModal.isOpen || ratingModal.isOpen || detailsModal.isOpen || locationModal.isOpen;
   ...
   }, [videoModal.isOpen, ratingModal.isOpen, detailsModal.isOpen, locationModal.isOpen]);
