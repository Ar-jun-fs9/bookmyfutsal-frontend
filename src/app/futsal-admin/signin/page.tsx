...
export default function FutsalAdminSignin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        sessionStorage.setItem("assigned_futsal", JSON.stringify(data.futsal));
        setRole("futsal_admin");
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setNotification({
          message: `OTP sent to ${forgotEmail}. OTP: ${data.otp_code}`,
          type: "info",
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <img
                  src="/logo/logo.png"
                  alt="BookMyFutsal"
                  className="h-12 w-12 rounded-lg ml-2 shadow-lg ring-2 ring-green-400/50"
                />
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-green-500/20 py-4  bg-linear-to-b from-gray-900/95 to-green-900/95 backdrop-blur-md ">
              <nav className="flex flex-col space-y-4">
                ...
                <div className="flex flex-row space-x-3 pt-4 border-t border-green-500/20 px-2">
                  <Link
                    href="/user/login"
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
            ...
            <div className="relative p-6 sm:p-8">
              ...
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-linear-to-br from-green-500 to-green-600 rounded-full mb-3 shadow-lg">
                  <svg
                ...
                <p className="text-gray-600 text-sm">
                  {showForgotPassword
                    ? forgotStep === 1
                      ...
                      : "Reset your password to continue"
                    : "Sign in to your Futsal Admin account"}
                </p>
              </div>
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      <div className="flex items-center">
                        <div
                          className={
                            ...
                            (forgotStep >= 1 ? "bg-green-500" : "bg-gray-300")
                          }
                        >
                          {forgotStep > 1 ? (
                            <svg
                      ...
                      <div className="flex items-center">
                        <div
                          className={
                            "w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm " +
                            (forgotStep >= 2 ? "bg-green-500" : "bg-gray-300")
                          }
                        >
                          {forgotStep > 2 ? (
                            <svg
                      ...
                      <div className="flex items-center">
                        <div
                          className={
                            "w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm " +
                            (forgotStep >= 3 ? "bg-green-500" : "bg-gray-300")
                          }
                        >
                          <span>3</span>
                        </div>
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              if (response.ok) {
                                setNotification({
                                  message: `OTP resent to ${forgotEmail}. OTP: ${data.otp_code}`,
                                  type: "info",
                                }); // Remove OTP display in production
